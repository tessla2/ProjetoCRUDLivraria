...
<body>
    <div class="container-painel">
        ...
        <h1>Consulta por Ano de Publicação</h1>
        <div class="content">
            <form action="" method="GET" class="form-group">
                <label for="ano_publicacao" class="consulta-ano_publicacao">Indique o Ano:</label>        
        ...
        <div class="pesquisa">
            ...
            if (isset($_GET["pesquisa"])) {
                ...
                try {
                    ...
                    $consulta = $ligacao->prepare("SELECT * FROM bookssociety WHERE ano_publicacao LIKE ?");
                    $consulta->execute(["%$ano_publicacao%"]);
