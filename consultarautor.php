...
<body>
    <div class="container-painel">
        ...
        <h1>Consulta por Autor</h1>
        <div class="content">
            <form action="" method="GET" class="form-group">
                <label for="autor" class="consulta-autor">Indique o Autor:</label>        
                <input type="text" name="autor" id="autor" class="consulta-input"> 
        ...
        <div class="pesquisa">
            ...
            if (isset($_GET["pesquisa"])) {
                ...
                try {
                    ...
                    $consulta = $ligacao->prepare("SELECT * FROM bookssociety WHERE autor LIKE ?");
