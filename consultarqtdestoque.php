...
<body>
    <div class="container-painel">
        ...
        <h1>Consulta por Quantidade em Estoque</h1>
        <div class="content">
            <form action="" method="GET" class="form-group">
                <label for="qtdestoque" class="consulta-isbn">Indique a quantidade:</label>        
                <div class="form-group">
         <input type="number" id="qtdestoque" name="qtdestoque" required>
         </div>
        <div class="form-group">
        <input type="submit" name="pesquisa" id="pesquisa" value="PESQUISAR"></div>
            </form>  
        </div>
        <div class="pesquisa">
            <?php
            if (isset($_GET["pesquisa"])) {
                ...
                try {
                    ...
                    $consulta = $ligacao->prepare("SELECT * FROM bookssociety WHERE qtdestoque LIKE ?");
                    $consulta->execute(["%$qtdestoque%"]);
