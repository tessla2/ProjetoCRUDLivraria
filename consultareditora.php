...
<body>
    <div class="container-painel">
        ...
        <h1>Consulta por Editora</h1>
        <div class="content">
            <form action="" method="GET" class="form-group">
                <label for="editora" class="consulta-editora">Indique o Editora:</label>        
                <input type="text" name="editora" id="editora" class="consulta-input"> 
        ...
        <div class="pesquisa">
            ...
            if (isset($_GET["pesquisa"])) {
                ...
                try {
                    ...
                    $consulta = $ligacao->prepare("SELECT * FROM bookssociety WHERE editora LIKE ?");
                    $consulta->execute(["%$editora%"]);
