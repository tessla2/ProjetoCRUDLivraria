...
<body>
    <div class="container-painel">
        ...
        <h1>Consulta por Título</h1>
        <div class="content">
            <form action="" method="GET" class="form-group">
                <label for="titulo" class="consulta-titulo">Indique o Título:</label>        
                <input type="text" name="titulo" id="titulo" class="consulta-input"> 
        ...
        <div class="pesquisa">
            ...
            if (isset($_GET["pesquisa"])) {
                ...
                try {
                    ...
                    $consulta = $ligacao->prepare("SELECT * FROM bookssociety WHERE titulo LIKE ?");
