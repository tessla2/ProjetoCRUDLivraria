...
<body>
    <div class="container-painel">
        ...
        <h1>Consulta por Preço</h1>
        <div class="content">
            <form action="" method="GET" class="form-group">
                <label for="preco" class="consulta-isbn">Indique o Preço:</label>        
        ...
        <div class="pesquisa">
            ...
            if (isset($_GET["pesquisa"])) {
                ...
                try {
                    ...
                    $consulta = $ligacao->prepare("SELECT * FROM bookssociety WHERE preco LIKE ?");
                    $consulta->execute(["%$preco%"]);
